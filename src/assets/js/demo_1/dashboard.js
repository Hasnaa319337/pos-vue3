;(function ($) {
  ...
  $(function () {
    ...
    if ($('#sales-statistics-overview').length) {
      var salesChartCanvas = $('#sales-statistics-overview')
        .get(0)
        .getContext('2d')
        ...
        datasets: [
          {
            label: 'Total Revenue',
            data: [
              56, 55, 59, 59, 59, 57, 56, 57, 54, 56, 58, 57, 59, 58, 59, 57,
              55, 56, 54, 52, 49, 48, 50, 50, 46, 45, 49, 50, 52, 53, 52, 55,
              54, 53, 56, 55, 56, 55, 54, 55, 57, 58, 56, 55, 56, 57, 58, 59,
              58, 57, 55, 53, 52, 55, 57, 55, 54, 52, 55, 57, 56, 57, 58, 59,
              58, 59, 57, 56, 55, 57, 58, 59, 60, 62, 60, 59, 58, 57, 56, 57,
              56, 58, 59,
            ],
            borderColor: '#9B86F1',
    ...
    if ($('#market-overview-chart').length) {
      var MarketingChartCanvas = $('#market-overview-chart')
        .get(0)
        .getContext('2d')
    ...
    if ($('#realtime-statistics').length) {
      var realtimeChartCanvas = $('#realtime-statistics')
        .get(0)
        .getContext('2d')
