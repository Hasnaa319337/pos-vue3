...
declare global {
  ...
  interface StencilIntrinsicElements
    extends JSXElements.DefaultIntrinsicElements {}
...
export namespace JSXElements {
  ...
  export interface HTMLAttributes<T = HTMLElement>
    extends StencilGlobalHTMLAttributes,
      DOMAttributes {
    // vdom specific
    innerHTML?: string
    ref?: (elm?: T) => void
...
export interface FunctionalUtilities {
  forEach: (
    children: FVNode[],
    cb: (vnode: ChildNode, index: number, array: FVNode[]) => void
  ) => void
  map: (
    children: FVNode[],
    cb: (vnode: ChildNode, index: number, array: FVNode[]) => ChildNode
  ) => FVNode[]
}
