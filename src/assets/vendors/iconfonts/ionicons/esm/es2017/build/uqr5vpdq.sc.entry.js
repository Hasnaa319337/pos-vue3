...
class Icon {
  ...
  loadIcon() {
    if (!this.isServer && this.isVisible) {
      ...
      if (url) {
        getSvgContent(this.doc, url, 's-ion-icon').then(
          svgContent => (this.svgContent = svgContent)
        )
      } else {
