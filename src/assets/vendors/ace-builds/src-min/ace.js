      ...
      var r = e('../lib/event'),
        ...
        l = function (e, t) {
            ...
            C = function (e) {
              T && ((e = T(e)), (T = null)),
                h
                  ...
                  : (e.substring(0, 2) == l
                      ? (e = e.substr(2))
                      : e.charAt(0) == l.charAt(0)
                      ? (e = e.substr(1))
                      : e.charAt(e.length - 1) == l.charAt(0) &&
                        (e = e.slice(0, -1)),
                    e.charAt(e.length - 1) == l.charAt(0) &&
                      (e = e.slice(0, -1)),
                    e && t.onTextInput(e)),
          ...
          var D = function (e) {
              ...
              ;(p = {}),
                (p.canUndo = t.session.$undoManager),
                t.onCompositionStart(),
                setTimeout(P, 0),
                t.on('mousedown', H),
                p.canUndo &&
          ...
          r.addListener(n, 'compositionstart', D),
            ...
            (this.moveToMouse = function (e, o) {
              ...
              t.renderer.$keepTextAreaAtCursor &&
                (t.renderer.$keepTextAreaAtCursor = null),
                clearTimeout(j),
                i.isWin && r.capture(t.container, h, F)
            }),
          ...
          r.implement(this, u),
            ...
            (this.$getUndoSelection = function (e, t, n) {
              ...
              var i = e[0],
                ...
                u = !1
              r(i)
                ? ((s = l.fromPoints(i.start, i.end)), (u = !0))
                : ((s = l.fromPoints(i.start, i.start)), (u = !1))
                  ...
                  r(i)
                    ...
                    : ((o = i.start),
                      s.compare(o.row, o.column) == -1 &&
                        (s = l.fromPoints(i.start, i.start)),
                      (u = !1))
              if (n != null) {
                l.comparePoints(n.start, s.start) === 0 &&
        ...
        function () {
          ;(this.ranges = null),
            ...
            (this.rectangularRangeBlock = function (e, t, n) {
              ...
              for (var p = c; p <= h; p++) {
                var d = i.fromPoints(
                  this.session.screenToDocumentPosition(p, o, a),
                  this.session.screenToDocumentPosition(p, u, f)
                )
                if (d.isEmpty()) {
