                                      ...
                                      ;(_ = b - a - 1) &&
                                        (1 === _
                                          ...
                                          : ((c = e.scope.freeVariable('i', {
                                            ...
                                            (o = c + '++'),
                                            i.push(P.compileToFragments(e, T))))
                                      continue
                                    }
                                    ;(v = g.unwrap().value),
                              ...
                              return (
                                ...
                                '!' === t && this.first instanceof c
                                  ...
                                  : ((i = '+' === t || '-' === t),
                                    ...
                                    r.push(this.first.compileToFragments(e, N)),
                                    this.flip && r.reverse(),
                                    this.joinFragmentArrays(r, ''))
                              )
                            }),
