define('ace/ext/chromevox', [
  ...
  var b = null,
    ...
    M = function (e) {
      w[e.row] && cvox.Api.playEarcon(c),
        E ? (cvox.Api.stop(), W(e), R(A(e)), I(e.row, 1)) : I(e.row, 0)
    },
    _ = function (e) {
      var t = O(e),
    ...
    $ = function (e, t) {
      r.editor.selection.isEmpty()
        ? S
          ? X(e, t)
          : V(e, t)
        : (X(e, t), cvox.Api.speak('selected', 1))
    },
    J = function (e) {
      if (x) {
        x = !1
    ...
    ct = function () {
      ...
      t.setAttribute('contextMenuActions', JSON.stringify(e)),
        t.addEventListener('ATCustomEvent', lt, !0)
    },
    ht = function (e) {
    ...
    vt = function (e, t) {
      ;(r.editor = t),
        t.getSession().selection.on('changeCursor', J),
        t.getSession().selection.on('changeSelection', K),
        t.getSession().on('change', Q),
        t.getSession().on('changeAnnotation', Z),
        t.on('changeStatus', ft),
        t.on('findSearchBox', ht),
        t.container.addEventListener('keydown', at),
        (b = t.selection.getCursor())
    },
    mt = function (e) {
      vt(null, e),
