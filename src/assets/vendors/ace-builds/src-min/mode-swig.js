    ...
    function (e, t, n) {
      ...
      var r = e('../lib/oop'),
        ...
        u = function () {
          s.call(this)
          var e =
            'autoescape|block|else|elif|extends|filter|for|if|import|include|macro|parent|raw|set|spaceless'
          e = e + '|end' + e.replace(/\|/g, '|end')
          var t =
              'addslashes|capitalize|date|default|escape|first|groupBy|join|json|last|lower|raw|replace|reverse|safe|sort|striptags|title|uniq|upper|url_encode|url_decode',
            ...
            o = this.createKeywordMapper(
              {
                'keyword.control.swig': e,
                'support.function.swig': t + '|' + n,
                'keyword.operator.swig': i,
                'constant.language.swig': r,
              },
              'identifier'
            )
          for (var u in this.$rules)
            this.$rules[u].unshift(
              ...
              { token: 'meta.tag.swig', regex: '\\{%-?', push: 'swig-start' },
              {
          ...
          ;(this.$rules['swig-comment'] = [
            { token: 'comment.block.swig', regex: '.*-?#}', next: 'pop' },
          ]),
            ...
            (this.$rules['swig-qqstring'] = [
              ...
              { token: 'string', regex: '"', next: 'swig-start' },
              { defaultToken: 'string' },
            ]),
