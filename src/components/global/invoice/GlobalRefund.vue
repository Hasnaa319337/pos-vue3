        ...
        >
          <div class="col p-0" style="text-align: right">
            <div class="col-auto p-0">
              <div class="right_header_parent">
                <h1 class="title" style="color: #353f4d; margin-bottom: 15px">
                  <strong>
          ...
          <div class="col p-0" style="text-align: left">
            <div class="right_header_parent">
              <h1
                class="title"
                style="color: #353f4d; margin-bottom: 15px,font-size: 20px"
              >
                <strong>
        ...
        >
          <div class="col">
            <div class="row justify-content-between">
              <div class="col-auto p-0">
                <div class="right_header_parent">
                  <p style="margin: 5px 0; font-size: 18px !important">
                    <span
                      style="
                        color: #828282;
                  ...
                  <p style="margin: 5px 0">
                    ...
                    <span
                      style="
                        ...
                        font-family: 'BahijTheSansArabic-Bold';
                      "
                      >{{ _.get(refund, 'provider.tax_num') }}</span
                    >
                  </p>
          ...
          <div class="col p-0">
            ...
            <p style="margin: 5px 0; font-size: 18px !important">
              ...
              <span
                ...
                "
              >
                {{ refund.provider_inv_number }}</span
              >
            </p>

            <p
              style="margin: 5px 0; font-size: 18px !important"
            ...
            <p style="margin: 5px 0; font-size: 18px !important">
              ...
              <span
                ...
                "
              >
                {{ trans(refund.payment_type) }}</span
              >
            </p>
            <p style="margin: 5px 0; font-size: 18px !important">
              <span
              ...
              <span
                ...
                v-else
              >
                {{ trans(refund.payment_method) }}</span
              >
            </p>
          </div>
        </b-row>
        ...
        <div class="row justify-content-between align-items-start m-0" style="">
          ...
          >
            ...
            >
              ...
              <b class="px-3" style="letter-spacing: 0px">
                {{
                  parseFloat(refund.discount_amount)
                    .toFixed(2)
                    .replace(/\d(?=(\d{3})+\.)/g, '$&,')
                }}&nbsp;
              </b>
            ...
            >
              ...
              <b class="px-3" style="letter-spacing: 0px">
                {{
                  parseFloat(refund.subtotal - refund.discount_amount)
                    .toFixed(2)
                    .replace(/\d(?=(\d{3})+\.)/g, '$&,')
                }}&nbsp;
              </b>
            ...
            >
              <b
                ...
                "
                >{{ trans('added_tax_value') }} ({{
                  refund.tax_percentage
                }}
                %)</b
              >
              <b class="px-3" style="letter-spacing: 0px">
                {{
                  parseFloat(refund.tax_amount)
                    .toFixed(2)
                    .replace(/\d(?=(\d{3})+\.)/g, '$&,')
                }}&nbsp;
              </b>
