    ...
    >
      ...
      >
        ...
        <div class="row" style="margin: 3px 0">
          ...
          <span>{{ getSetting('commercial_number') }}</span>
        </div>
        <div class="row" style="margin: 3px 0">
          <span>{{ trans('phone number') }} : </span>
          <span>{{ getSetting('company_phone') }}</span>
        </div>
        <div class="row" style="margin: 3px 0">
      ...
      >
        <h2
          ...
          "
        >
          فاتورة مبيعات ضريبية {{ trans('simplified') }}
        </h2>
        <div class="row" style="margin: 3px 0">
        ...
        <h1>
          <div class="row">
            <div class="col-12">
              ...
              >
                <span
                  >{{ trans('adding_added_tax') }} {{ item.tax_percentage }} %
                </span>
                <span>{{ parseFloat(item.product_tax).toFixed(2) }} </span>
              </div>
            </div>
          </div>
        </h1>
