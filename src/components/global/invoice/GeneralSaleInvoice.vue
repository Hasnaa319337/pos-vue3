    ...
    >
      <div>
                  ...
                  <p style="margin: 5px 0">
                    ...
                    <span
                      style="
                        ...
                        font-family: 'BahijTheSansArabic-Bold';
                      "
                      >{{ _.get(sale, 'customer.tax_num') }}</span
                    >
                  </p>
          ...
          <div class="col p-0">
            ...
            <p style="margin: 5px 0; font-size: 18px !important">
              ...
              <span
                ...
                v-else
              >
                {{ trans(sale.payment_method) }}</span
              >
            </p>
          </div>
        </b-row>
        ...
        <div class="row justify-content-between align-items-start m-0" style="">
          ...
          >
            ...
            >
              ...
              <b class="px-3" style="letter-spacing: 0px">
                {{
                  parseFloat(sale.subtotal - sale.discount_amount)
                    .toFixed(2)
                    .replace(/\d(?=(\d{3})+\.)/g, '$&,')
                }}&nbsp;
              </b>
            ...
            >
              <b
                ...
                style="
                  ...
                  letter-spacing: 0px;
                "
                >{{ trans('added_tax_value') }} ({{ item.tax_percentage }} %)</b
              >
              <b class="px-3" style="letter-spacing: 0px">
                {{
                  parseFloat(item.product_tax)
                    .toFixed(2)
                    .replace(/\d(?=(\d{3})+\.)/g, '$&,')
                }}
                <!-- {{
        ...
        >
          ...
          <div class="col-sm-auto col-12 totals mb-3" style="max-width: 45%">
            <div
              class="row justify-content-between"
              style="
                font: normal normal bold 13px/20px Tahoma;
            ...
            <div
              ...
              "
            >
              <b class="px-3">{{ trans('refund total') }}</b>
              <b class="px-3" style="font: normal normal bold 13px/20px Tahoma">
            ...
            >
              ...
              >
              <b class="px-3" style="letter-spacing: 0px; color: #394e85">
                {{ sale.total - refund.total_refunded }}
                {{ getSetting('currency', settings) }}
              </b>
            </div>
            <div class="row justify-content-between">
