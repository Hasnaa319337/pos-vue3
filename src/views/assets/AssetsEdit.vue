  ...
  <div>
    <div class="col-sm-12 grid-margin stretch-card">
      <div class="card">
        ...
        >
          <h4 class="card-title">{{ trans('AssetsEdit') }}</h4>
          <div class="dropdown">
                    ...
                    <div class="col-6">
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            <b-form-select-option
                              v-for="period in depreciation_types"
                              :value="period"
                              :key="period"
                            >
                              <span>{{ period }}</span>
                    ...
                    <div class="col-6">
                      ...
                      >
                        <b-form-group :label="trans('depreciation_value_type')">
                          ...
                          >
                            <b-form-select-option
                              v-for="val in depreciation_values"
                              :value="val"
                              :key="val"
                            >
                              <span>{{ val }}</span>
  ...
  methods: {
    refresh() {
      axios
        ...
        .then(res => {
          this.asset = res.data.body.asset
          this.asset.purchases_date =
            res.data.body.asset.purchases_date.split(' ')[0]
      ...
      axios
        ...
        .then(res => {
          ...
          this.strings = res.data.body.strings
          this.loaded = true
          let acc = this.accounts.find(x => x.title === this.asset.main_account)
          this.asset.main_account = acc.account
        })
        .catch(error => {
          this.message = error.response.data.message
          this.alertType = 'danger'
    ...
    store() {
      ...
      axios
        .put('/api/assets/' + this.$route.params.id, data)
        .then(
          res => {
            if (res.data.status) {
