  ...
  <div class="col-sm-12 grid-margin stretch-card">
    <div class="card" v-if="loaded">
      ...
      <div class="card-header header-sm d-flex justify-content-between align-items-center">
        <h4 class="card-title">{{ trans('add_store_transfer_voucher') }}</h4>
        <div class="dropdown">
          <GoBackButton />
        </div>
      </div>
      <b-form @submit.prevent="createTransferRequest()">
        ...
        <div class="d-flex" style="height: 70px">
          <div class="filter col-sm-6">
            ...
            >
              <b-form-select-option :value="inv.id" v-for="inv in inventories" :key="inv.id">
                {{ inv.title }}
          ...
          <div class="filter col-sm-6" style="margin-bottom: 35px">
            <b-form-select
              style="
                ...
                outline: 0;
              "
              v-model="product.to_inventory_id"
            >
              <b-form-select-option :value="inv.id" v-for="inv in inventories" :key="inv.id">
                {{ inv.title }}
              </b-form-select-option>
...
export default {
  ...
  methods: {
    ...
    createTransferRequest() {
      axios
        .post('/api/inventory-transfer/inventory-transfers', this.product)
        .then((res) => {
          if (res.data.status == true) {
            ...
            setTimeout(() => {
              this.$router.push(
                '/inventory-transfer/inventory-transfers/' + res.data.body.inventory_transfer.id
              )
            }, 3000)
          }
        })
