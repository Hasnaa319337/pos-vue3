              ...
              >
                <b-form-group :label="trans('section_name') + ' ( Ar ) '">
                  <b-input
                    ...
                    "
                    v-model="account.translation.title.ar"
                ...
                <b-form-group :label="trans('section_name') + ' ( Ar ) '">
                  <b-input
                    ...
                    style="
                      ...
                      border: 1px solid #17a2b8;
                    "
                    v-model="account.translation.title.en"
                    :state="errors[0] ? false : valid ? true : null"
                  ></b-input>
                  <b-form-invalid-feedback id="inputLiveFeedback">
                ...
                <b-tbody class="request_body">
                  <b-tr v-for="(item, index) in account.items" :key="item.id">
                    <b-td>
                      ...
                      >
                        <b-form-select-option
                          v-for="(key, val) in financial_equations_types"
                          :key="key"
                          :value="val"
                        >
                          {{ key }}
...
export default {
  ...
  methods: {
    getSection() {
      axios({
        method: 'GET',
        url: '/api/financial-list/financial-list-sections/' + this.$route.params.id
      })
        .then((res) => {
    ...
    updateFinancialStatment() {
      let myData = {
        ...
        title: this.account.translation.title,
        mathematics_operator: this.account.mathematics_operator,
        type: this.account.type
      }
      axios
        .put(`/api/financial-list/financial-list-sections/${this.$route.params.id}`, myData)
    ...
    enums() {
      axios({
        ...
        this.financial_equations_types = res.data.body.financial_reference_type
      })
    }
  }
}
